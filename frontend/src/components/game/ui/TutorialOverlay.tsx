...
const TutorialOverlay: React.FC = () => {
  ...
  const handleSkip = () => {
    if (
      window.confirm(
        'Are you sure you want to skip the tutorial? You can always replay it later from the settings.'
      )
    ) {
      skipTutorial();
    }
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className="relative bg-heist-panel border-2 border-cyan-400 rounded-xl shadow-2xl overflow-hidden"
