    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {availableCharacters.map(character => (
          <div
            key={character.id}
            className="bg-heist-panel border border-heist-border rounded-xl p-6 hover:border-cyan-400/50 hover:shadow-cyan-glow transition-all duration-200 shadow-hud-panel"
          >
