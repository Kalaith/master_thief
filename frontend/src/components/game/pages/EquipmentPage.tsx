          ...
          {equipmentInventory.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {equipmentInventory.map(item => (
                <div
                  key={item.id}
                  className={`bg-heist-panel rounded-xl p-6 border-2 shadow-hud-panel hover:shadow-${
                    item.rarity === 'legendary'
                      ? 'amber-glow border-amber-400/50'
                      : item.rarity === 'masterwork'
                        ? 'purple-glow border-purple-400/50'
                        : item.rarity === 'advanced'
                          ? 'cyan-glow border-cyan-400/50'
                          : item.rarity === 'improved'
                            ? 'emerald-400/30 border-emerald-400/50'
                            : 'border-heist-border'
                  } transition-all`}
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div
                      className={`flex items-center gap-1 px-2 py-1 rounded text-xs font-bold font-mono ${
                        item.rarity === 'legendary'
