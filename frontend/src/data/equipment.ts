...
export const basicEquipment: Equipment[] = [
...

  {
    ...
    requiredLevel: 12,
    specialEffects: [
      'Interface directly with electronics',
...

  {
    ...
    rarity: 'masterwork',
    description:
      'Professional-grade tools for any situation. A craftsman is only as good as their tools.',
...
export const equipmentSets = [
  {
    ...
    setBonuses: {
      ...
      3: {
        skillBonuses: { stealth: 2, lockpicking: 2 },
        description: '3-piece: +2 Stealth, +2 Lockpicking',
      },
      4: {
        attributeBonuses: { dexterity: 1 },
        skillBonuses: { stealth: 2, lockpicking: 2 },
        description: '4-piece: Previous bonuses + 1 Dexterity',
      },
      5: {
        attributeBonuses: { dexterity: 2 },
...

  {
    ...
    setBonuses: {
      ...
      3: {
        skillBonuses: { hacking: 3, lockpicking: 2 },
        description: '3-piece: +3 Hacking, +2 Lockpicking',
      },
      4: {
        attributeBonuses: { intelligence: 1 },
        skillBonuses: { hacking: 3, lockpicking: 2 },
        description: '4-piece: Previous bonuses + 1 Intelligence',
      },
      5: {
        attributeBonuses: { intelligence: 2 },
