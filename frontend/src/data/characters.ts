...
export const characters: TeamMember[] = [
  ...
  createCharacter(
    ...
    [
      'Left construction after workplace accident',
      'Started bonsai collection as therapy',
      'First heist was to help sick coworker',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      ...
      'Learned pickpocketing from carnival con artists',
      'Lost circus family in financial scandal',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Lost family fortune in bad investments',
      'Banned from most casinos',
      'Still believes in lucky streaks',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Grew up in arcade halls',
      'First hack was fixing broken games',
      'Treats technology as living beings',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      ...
      'Exposed dangerous stunt practices',
      'Believes duct tape fixes everything',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Led construction union strikes',
      'Started underground tool-lending network',
      'Names all her tools',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Dishonorably discharged for ethics',
      'Saved civilian lives against orders',
      'Applies military tactics to heists',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Betrayed by corporate employers',
      'Mastered ancient stealth techniques',
      'Finds peace in tea ceremonies',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Street art is their signature',
      'Cannot resist leaving artistic marks',
      'Escapes via urban parkour',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Former government black ops hacker',
      'Discovered government surveillance program',
  ...
  createCharacter(
    ...
    [
      ...
      'Has secrets in every major city',
  ...
  createCharacter(
    ...
    [
      'Led digital revolution against corporations',
      'Hair color changes with emotions',
      'Sees code as art form',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      ...
      'Follows strict personal honor code',
      'Meditation and martial arts master',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Specializes in art theft',
      'Writes love letters to stolen objects',
      'Only steals things of beauty',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'World-famous jazz performer',
      'Every show is an elaborate con',
      'Has contacts in every major city',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      'Designed many heist target buildings',
      'Left security consulting after ethical concerns',
  ...
  createCharacter(
    ...
    [
      ...
      'Studies astrology and omens',
      'Works only during specific moon phases',
    ]
  ),
  ...
  createCharacter(
    ...
    [
      ...
      'Controls vast criminal network',
      'Appears only when stakes are highest',
    ]
  ),
];
  ...
  mentorships: [
    {
      mentor: 'Brick',
      apprentice: 'Jinx',
      description: 'Gentle giant guides reckless artist',
    },
    {
      mentor: 'Glitch',
      apprentice: 'Tinker Tom',
      description: 'Neon rebel teaches device whisperer',
    },
    {
      mentor: 'Razor',
      apprentice: 'Jinx',
      description: 'Stunt double teaches advanced moves',
    },
    {
      mentor: 'Madame Mirage',
      apprentice: 'Echo',
      description: 'Illusionist mentors voice mimic',
    },
    {
      mentor: 'Nyx',
      apprentice: 'Jinx',
      description: "Night's omen teaches patience",
    },
  ],
  ...
  romanticTensions: [
    {
      character1: 'Shade',
      character2: 'Sable',
      description: 'Cynical phantom meets romantic thief',
    },
  ],

  professionalRivalries: [
    {
      character1: 'Switchblade Sally',
      character2: 'Shade',
      description: 'Carnival queen vs cynical phantom',
    },
    {
      character1: 'Glitch',
      character2: 'Ghostwire',
      description: 'Neon rebel vs anonymous ghost',
    },
    {
      character1: 'Velvet Vox',
      character2: 'Madame Mirage',
      description: 'Glamorous songbird vs mysterious illusionist',
    },
    {
      character1: 'Professor Cipher',
      character2: 'Doc Carter',
      description: 'Academic strategist vs military tactician',
    },
  ],
  ...
  bonds: [
    {
      character1: 'Brick',
      character2: 'Nails',
      description: 'Construction workers bond over tools and trade',
    },
    {
      character1: 'Velvet Vox',
      character2: 'Lucky Pete',
      description: 'Protective entertainer looks after optimistic conman',
    },
    {
      character1: 'Atlas Kane',
      character2: 'Razor',
      description: "Professional fighters respect each other's skills",
    },
  ],
